...
export const environment = {
    PRODUCTION: false,
    SERVER_URL: 'https://mbapptest.scsb.com.tw', // Server位置(UAT測試)
    API_URL: 'comm', // api入口(電文路徑)
    // API_URL: 'api', // api入口(電文路徑) (no gateway)
    // [包版模式設定]
    ONLINE: true, // 是否連線測試
    ...
    // CHALLENGE_RESPONSE_FLAG: false, // 啟動challenge response模式 (no gateway)
    ...
    LOG_LEVEL: ['LOG', 'Cache', 'Telegram', 'Security', 'LoadApp', 'Init', 'Mscale'],
