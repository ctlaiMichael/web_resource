...
export const environment = {
    ...
    OPEN_LOGIN: true, // 臨時需求!!!!(登入還沒好處理) true是會不檢核登入機制
    // -------------------- [開發專用設定] -------------------- //
    ...
    LOG_LEVEL: ['LOG', 'Cache', 'Telegram', 'Security', 'LoadApp', 'Init', 'TelegramBase', 'Mscale'],
    ...
    AUTH_TIME: 300, // mscale token timeout(need retry) 300 (=5 min)
