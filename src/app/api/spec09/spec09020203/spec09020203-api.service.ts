...
import { SPEC09020203Req } from './spec09020203-req';

// -- Other Library -- //

@Injectable()
export class SPEC09020203ApiService extends ApiTransBaseService {
    protected serviceId = 'SPEC09020203'; // API Name
    ...
    getData(reqData: object, option?: object, paginator?: object): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC09020203Req, {
            'reqData': reqData,
            'paginator': paginator
        });
