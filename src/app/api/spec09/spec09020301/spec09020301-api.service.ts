...
import { SPEC09020301Req } from './spec09020301-req';

// -- Other Library -- //

@Injectable()
export class SPEC09020301ApiService extends ApiBaseService {
    protected serviceId = 'SPEC09020301'; // API Name
    ...
    getData(reqData: object, option?: object, paginator?: object): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC09020301Req, {
            'reqData': reqData,
            'paginator': paginator
        });
