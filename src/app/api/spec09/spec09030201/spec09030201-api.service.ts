...
import { SPEC09030201Req } from './spec09030201-req';
// -- Other Library -- //

@Injectable()
export class SPEC09030201ApiService extends ApiTransBaseService {
    protected serviceId = 'SPEC09030201'; // API Name

    sendData(reqData: object, option?: object): Promise<any> {

        let sendObj = new ApiRequestOption(SPEC09030201Req, {
            'reqData': reqData
        });
        // 欄位檢核
