...
import { SPEC11040205Req } from './spec11040205-req';
// -- Other Library -- //

@Injectable()
export class SPEC11040205ApiService extends ApiBaseService {

    protected serviceId = 'SPEC11040205';
    ...
    sendData(reqData: object, option?: object): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC11040205Req, {
            'reqData': reqData
        });
