...
import { SPEC11040105Req } from './spec11040105-req';
// -- Other Library -- //

@Injectable()
export class SPEC11040105ApiService extends ApiBaseService {

    protected serviceId = 'SPEC11040105';
    ...
    sendData(reqData: object, option?: object): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC11040105Req, {
            'reqData': reqData
        });
