...
import { SPEC11040401Req } from './spec11040401-req';
// -- Other Library -- //

@Injectable()
export class SPEC11040401ApiService extends ApiTransBaseService {

    protected serviceId = 'SPEC11040401';
    ...
    sendData(reqData: object, option?: object): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC11040401Req, {
            'reqData': reqData
        });
