...
import { SPEC11040402Req } from './spec11040402-req';
// -- Other Library -- //

@Injectable()
export class SPEC11040402ApiService extends ApiTransBaseService {

    protected serviceId = 'SPEC11040402';
    ...
    sendData(reqData: object, option?: object): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC11040402Req, {
            'reqData': reqData
        });
