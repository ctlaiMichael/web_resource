...
import { SPEC11050402Req } from './spec11050402-req';
// -- Other Library -- //

@Injectable()
export class SPEC11050402ApiService extends ApiTransBaseService {

    protected serviceId = 'SPEC11050402';
    ...
    sendData(reqData: object, option?: object): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC11050402Req, {
            'reqData': reqData
        });
