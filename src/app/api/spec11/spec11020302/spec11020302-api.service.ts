...
import { SPEC11020302Req } from './spec11020302-req';
// -- Other Library -- //

@Injectable()
export class SPEC11020302ApiService extends ApiTransBaseService {
    protected serviceId = 'SPEC11020302'; // API Name
    ...
    sendData(reqData: object, option?: object): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC11020302Req, {
            'reqData': reqData
        });
        // 欄位檢核
        // 修改request
