...
import { SPEC11050201Req } from './spec11050201-req';
// -- Other Library -- //

@Injectable()
export class SPEC11050201ApiService extends ApiBaseService {
    protected serviceId = 'SPEC11050201'; // API Name
    ...
    getData(reqData: object, option?: object, type?: string): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC11050201Req, {
            'reqData': reqData
        });
