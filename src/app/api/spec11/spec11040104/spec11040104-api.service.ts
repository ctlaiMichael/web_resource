...
import { SPEC11040104Req } from './spec11040104-req';
// -- Other Library -- //

@Injectable()
export class SPEC11040104ApiService extends ApiBaseService {

    protected serviceId = 'SPEC11040104';
    ...
    getData(reqData: object, option?: object): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC11040104Req, {
            'reqData': reqData
        });
