...
import { SPEC11040206Req } from './spec11040206-req';
// -- Other Library -- //

@Injectable()
export class SPEC11040206ApiService extends ApiTransBaseService {

    protected serviceId = 'SPEC11040206';
    ...
    sendData(reqData: object, option?: object): Promise<any> {
        let sendObj = new ApiRequestOption(SPEC11040206Req, {
            'reqData': reqData
        });
