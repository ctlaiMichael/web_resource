...
@Component({
    selector: 'app-fund-inquiry-confirm-result',
    templateUrl: './fund-inquiry-confirm-result.component.html',
    styleUrls: []
})

export class FundInquiryConfirmResultComponent implements OnInit {
    ...
    private _initEvent() {
        ...
        let payDate = this._formateService.checkField(this.showData, 'payDate');
        this.formateDateData.formateDate = this._mainService.formatePaydate(payDate);
    ...
    onResultBtn() {
        ...
        this.onBackPageData(this.queryData, 'change-edit-special', 'retry');
    }
