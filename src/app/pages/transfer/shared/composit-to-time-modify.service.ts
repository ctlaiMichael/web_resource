...
export class CompositToTimeModifyService {
    /**
     * 參數處理
     */
    ...
    constructor(
        ...
        private spec09020202: SPEC09020202ApiService,
        private spec09020203: SPEC09020203ApiService
    ) {
    }
    ...
    getListData(reqData: object,  option?: object): Promise<any> {
        ...
        return this.spec09020202.getData(reqData, option).then(
            (sucessObj) => {
    ...
    getResultData(reqData: object,  option?: object): Promise<any> {
        this._logger.step('Deposit', "into getList, reqData/paginator:", reqData);
        return this.spec09020203.getData(reqData, option).then(
            (sucessObj) => {
                this._logger.log('Deposit', "send api success, success:", sucessObj);
                // this._cacheService.save(cache_key, sucessObj, cache_option);
                return Promise.resolve(sucessObj);
    ...
    modifyReqData(reqData, option?: object) {
        return this.spec09020203.modifyApiReq(reqData, option);
    }
